...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/wikiRace/static/race.css?filever={{raceCSS}}">
  </head>
  <body>
    <div id="main">
      <h1>Wiki Race</h1>
    ...
    <script type='text/javascript' src='/wikiRace/static/race.js?filever={{raceJS}}'></script>  
  </body>
</html>